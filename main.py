...
longpoll = VkBotLongPoll(vk_session, 170215431)


upload = vk_api.VkUpload(vk)

keyboard = VkKeyboard(one_time = False)
keyboard.add_button("лессс гоу", color = VkKeyboardColor.POSITIVE)
